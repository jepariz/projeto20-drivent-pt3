...
import { createUser, createEnrollmentWithAddress, createTicket, createTicketTypeWithOptions, createHotel, createTicketType, createRoom } from "../factories";
...
beforeAll(async () => {
  ...
  describe("GET /hotels/:hotelId", () => {
    ...
    describe("when token is valid", () => {
      ...
      it("should respond with status 400 when no hotelId is sent", async () => {
        const token = await generateValidToken();
